						...
						<tr bgcolor="#E7E7E7">
							<td height="14" colspan="4" background="<%=path %>/img/tbg.gif">&nbsp;商品管理&nbsp;</td>
    						    ...
    						    <td width="75%" bgcolor="#FFFFFF" align="left">
    						         <input type="text" name="uname" size="40" value="<%=rs.getString("uname") %>"/>
    						    </td>
    						</tr>
		                    													    			             <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
    						    <td width="25%" bgcolor="#FFFFFF" align="right">
    						    ...
    						    <td width="75%" bgcolor="#FFFFFF" align="left">
    						         <input type="text" name="upwd" size="40" value="<%=rs.getString("upwd") %>"/>
    						    </td>
    						</tr>
		                    													    			             <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
    						    <td width="25%" bgcolor="#FFFFFF" align="right">
    						    ...
    						    <td width="75%" bgcolor="#FFFFFF" align="left">
    						         <input type="text" name="nickname" size="40" value="<%=rs.getString("nickname") %>"/>
    						    </td>
    						</tr>
